...
export const Footer = () => {
  return (
    <footer className="bg-white border-t border-natural-accent py-24 px-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-20 text-natural-dark">
        <div className="col-span-1 md:col-span-1">
          ...
          <p className="text-natural-muted text-sm leading-relaxed mb-10 font-light italic">
        ...
        <div>
          <h4 className="text-[10px] font-bold uppercase tracking-[0.3em] mb-10 text-natural-primary">The Collection</h4>
          <ul className="space-y-6 text-xs font-bold uppercase tracking-widest text-natural-muted">
        ...
        <div>
           <h4 className="text-[10px] font-bold uppercase tracking-[0.3em] mb-10 text-natural-primary">Experience</h4>
           <ul className="space-y-6 text-xs font-bold uppercase tracking-widest text-natural-muted">
        ...
        <div>
          <h4 className="text-[10px] font-bold uppercase tracking-[0.3em] mb-10 text-natural-primary">Circle</h4>
          <p className="text-xs text-natural-muted mb-8 font-serif italic font-light">Join our circle for seasonal updates and private offers.</p>
          <div className="flex bg-natural-bg border border-natural-accent rounded-full p-1 group focus-within:ring-2 focus-within:ring-natural-primary/10 transition-all">
            <input 
              type="email" 
              placeholder="Your email" 
              className="bg-transparent border-none outline-none flex-1 px-6 text-sm font-medium"
            />
            <button className="bg-natural-primary text-white px-8 py-3 rounded-full text-[10px] font-bold uppercase tracking-widest hover:bg-natural-dark transition-all shadow-xl">
              Join
            </button>
          </div>
        </div>
